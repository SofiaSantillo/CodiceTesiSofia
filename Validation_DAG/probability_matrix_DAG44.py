...
def creation_matrix(df):
    ...
    return matrix_size_tfr, matrix_size_pdi, prob_marginale_tfr, prob_marginale_pdi, probabilità_congiunta_tot




if __name__ == "__main__":
    df=creation_dataset(log_path, dataset_path, DAG="DAG4.4")
    creation_matrix(df)