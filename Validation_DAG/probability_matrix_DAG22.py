...
def creation_matrix(df):
    ...
    return matrix_frr_size, matrix_frr_tfr, prob_marginale_frr, prob_marginale_size, prob_marginale_tfr, probabilità_congiunta_tot




if __name__ == "__main__":
    df=creation_dataset(log_path, dataset_path, DAG="DAG2.2")
    creation_matrix(df)