...
def creation_matrix(df):
    ...
    return matrix_tfr_pdi, matrix_size_pdi, prob_marginale_tfr, prob_marginale_pdi, probabilità_congiunta_tot




if __name__ == "__main__":
    df=creation_dataset(log_path, dataset_path, DAG="DAG4.3")
    creation_matrix(df)