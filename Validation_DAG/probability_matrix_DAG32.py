...
def creation_matrix(df):
    ...
    return matrix_frr_pdi, matrix_frr_tfr, prob_marginale_frr, prob_marginale_pdi, prob_marginale_tfr, probabilità_congiunta_tot




if __name__ == "__main__":
    df=creation_dataset(log_path, dataset_path, DAG="DAG3.2")
    creation_matrix(df)