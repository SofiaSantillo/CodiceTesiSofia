...
def creation_matrix(df):
    ...
    return matrix_frr_size, matrix_pdi_size, prob_marginale_frr, prob_marginale_size, probabilità_congiunta_tot




if __name__ == "__main__":
    df=creation_dataset(log_path, dataset_path, DAG="DAG1")
    creation_matrix(df)