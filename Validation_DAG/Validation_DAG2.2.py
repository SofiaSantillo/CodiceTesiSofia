...
# Funzione esposta che esegue tutta la pipeline e restituisce la percentuale ben spiegata
def percentage_well_done(lower=0.9, upper=1.1):
    logging.basicConfig(filename='_Logs/validation_DAG2.2.log', level=logging.INFO, format='%(asctime)s - %(message)s')
    ...
    # Calcolo delle distribuzioni marginali e condizionate secondo il DAG: FRR → TFR e FRR → SIZE
