...
from random_forest_multioutput import random_forest_size_pdi
...
def functionalize_xgboost_gridsearch_size(seed, best_model_info):
    ...
    logger_SIZE.info("Starting the XGBoost model training process for predicting SIZE...".upper())
    ...
    # Grid search
    param_grid = {
        'regressor__estimator__n_estimators': [50, 100, 200, 400, 800],
...
for seed in seeds:
    functionalize_xgboost_gridsearch_size(seed, best_model_info)
