...
df = pd.read_csv('Data_Droplet/seed_Droplet.csv')
...
plt.savefig("_Images/dag_Causalnex_seed_Droplet.png", format="PNG")

plt.close()  

with open("_Log/causal_dependencies_seed_Droplet.log", "w") as log_file:
