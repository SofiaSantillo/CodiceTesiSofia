...
real_csv_size = "4_SAMPLING/_csv/_csv_archive/real_r_SIZE0.csv"
real_csv_pdi = "4_SAMPLING/_csv/_csv_archive/real_r_PDI0.csv"


sim_folder = "4_SAMPLING/_csv/_csv_archive"
log_folder = "4_SAMPLING/_logs"
os.makedirs(log_folder, exist_ok=True)
log_file = os.path.join(log_folder, "MAE_r_comparison0.log")
