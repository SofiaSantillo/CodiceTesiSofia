...
if __name__ == "__main__":
    edges = [('AQUEOUS', 'ESM'), ('AQUEOUS', 'PEG'), ('AQUEOUS', 'SIZE'), ('CHIP', 'PDI'), ('CHOL', 'ESM'), ('CHOL', 'PDI'), ('ESM', 'PDI'), ('ESM', 'SIZE'), ('FRR', 'CHOL'), ('FRR', 'PEG'), ('ML', 'ESM'), ('ML', 'HSPC'), ('ML', 'PEG'), ('TFR', 'CHOL')]

    dag = DAG(edges)
    start, end = "ML", "PEG"

    output_file = "3_D-SEPARATION/_logs/paths_C9_M8.log"
