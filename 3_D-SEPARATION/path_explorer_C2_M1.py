...
if __name__ == "__main__":
    edges = [('AQUEOUS', 'ESM'), ('AQUEOUS', 'SIZE'), ('CHIP', 'PDI'), ('CHOL', 'ESM'), ('CHOL', 'PDI'), ('ESM', 'PDI'), ('ESM', 'SIZE'), ('FRR', 'CHOL'), ('ML', 'ESM'), ('ML', 'HSPC'), ('ML', 'PEG'), ('TFR', 'CHOL')]

    dag = DAG(edges)
    start, end = "PDI", "SIZE"

    output_file = "3_D-SEPARATION/_logs/paths_C2_M1.log"
