...
if __name__ == "__main__":
    edges = [('AQUEOUS', 'ESM'), ('CHIP', 'PDI'), ('CHOL', 'ESM'), ('CHOL', 'PDI'), ('ESM', 'PDI'), ('ESM', 'SIZE'), ('FRR', 'CHOL'), ('ML', 'ESM'), ('ML', 'HSPC'), ('ML', 'PEG'), ('SIZE', 'PDI'), ('TFR', 'CHOL')]

    dag = DAG(edges)
    start, end = "TFR", "FRR"

    output_file = "3_D-SEPARATION/_logs/paths_C3_M2.log"
