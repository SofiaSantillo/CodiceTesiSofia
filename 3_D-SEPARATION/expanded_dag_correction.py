...
def find_duplicate_dags(file_path):
    ...
    for block in blocks:
        ...
        # Normalizza: set di tuple ordinato per evitare differenze di ordine
...
def parse_and_clean_dags(file_path, output_path):
    ...
    with open(output_path, "w", encoding="utf-8") as out_f:
        for block in blocks:
            ...
            # Rimuovi arco AQUEOUS <-> PEG se presente
...
if __name__ == "__main__":
    ...
    input_file = "3_D-SEPARATION/_logs/dag_structures.log"  # <-- metti qui il tuo file
    ...
    dag_file = "3_D-SEPARATION/_logs/expanded_Dags_clean.log"  # file con tutti i DAG
    ...
    # Separiamo i DAG usando "Edges:" come separatore
    dag_texts = content.split("Edges:")[1:]  # primo split vuoto
    dag_edges_list = []

    for dag_text in dag_texts:
        edges_str = dag_text.split("]")[0] + "]"  # prendi fino alla chiusura della lista
