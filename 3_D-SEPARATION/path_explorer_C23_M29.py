...
if __name__ == "__main__":
    edges = [('AQUEOUS', 'ESM'), ('CHIP', 'PDI'), ('CHOL', 'ESM'), ('CHOL', 'PDI'), ('ESM', 'PDI'), ('ESM', 'SIZE'), ('FRR', 'CHOL'), ('FRR', 'PEG'), ('ML', 'ESM'), ('ML', 'HSPC'), ('PEG', 'HSPC'), ('TFR', 'CHOL')]

    dag = DAG(edges)
    start, end = "FRR", "PEG"

    output_file = "3_D-SEPARATION/_logs/paths_C23_M29.log"
