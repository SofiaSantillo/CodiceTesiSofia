...
if __name__ == "__main__":
    edges = [('AQUEOUS', 'CHOL'), ('AQUEOUS', 'ESM'), ('CHIP', 'PDI'), ('CHOL', 'ESM'), ('CHOL', 'PDI'), ('ESM', 'CHOL'), ('ESM', 'PDI'), ('ESM', 'SIZE'), ('FRR', 'HSPC'), ('HSPC', 'PEG'), ('ML', 'ESM'), ('ML', 'HSPC'), ('TFR', 'CHOL')]

    dag = DAG(edges)
    start, end = "CHIP", "SIZE"

    output_file = "3_D-SEPARATION/_logs/paths_C366_M456.log"
