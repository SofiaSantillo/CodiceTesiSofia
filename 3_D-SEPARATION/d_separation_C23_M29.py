...
log_file = "3_D-SEPARATION/_logs/paths_C23_M29.log"
...
if __name__ == "__main__":
    ...
    cmi_df = compute_cmi_paths(paths, df, x_col="FRR", y_col="PEG")
    print(cmi_df)
    cmi_df.to_csv("3_D-SEPARATION/_logs/cmi_C23_M29.log", index=False)
