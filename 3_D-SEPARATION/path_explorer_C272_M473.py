...
if __name__ == "__main__":
    edges = [('AQUEOUS', 'HSPC'), ('AQUEOUS', 'PEG'), ('CHIP', 'PDI'), ('CHOL', 'ESM'), ('CHOL', 'PDI'), ('ESM', 'PDI'), ('ESM', 'SIZE'), ('FRR', 'HSPC'), ('ML', 'ESM'), ('ML', 'HSPC'), ('PEG', 'HSPC'), ('TFR', 'CHOL')]

    dag = DAG(edges)
    start, end = "ESM", "HSPC"

    output_file = "3_D-SEPARATION/_logs/paths_C272_M473.log"
