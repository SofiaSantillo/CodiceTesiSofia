...
log_file = "3_D-SEPARATION/_logs/paths_C2_M1.log"
...
if __name__ == "__main__":
    ...
    cmi_df = compute_cmi_paths(paths, df, x_col="PDI", y_col="SIZE")
    print(cmi_df)
    cmi_df.to_csv("3_D-SEPARATION/_logs/cmi_C2_M1.log", index=False)
