...
if __name__ == "__main__":
    edges = [('ESM','ML'),('HSPC','ML'),('PEG','HSPC'),('AQUEOUS','TFR'),('CHOL','PDI'),('ML','PDI'),('CHIP','SIZE'),('CHIP','PDI'),('TFR','CHIP'),('FRR','TFR'), ('FRR','CHIP'), ('AQUEOUS','CHIP'), ('ML','SIZE')]
    dag = DAG(edges)
    start, end = "PEG", "CHOL"

    output_file = "3_D-SEPARATION/_logs/paths_DAG_IPOTIZZATO.log"
